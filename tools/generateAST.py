...
class GenerateAst:
    ...
    def generateAst(self):
        ...
        self.__defineAst(
            ...
            imports={"typing": ["Any"], "scanner.token": ["Token"]},
        )
    ...
    def __createOutputDirectory(self):
    ...
    def __defineAst(self, base_name: str, types: list, imports: dict[str, list]):
        """
        Create new AST class

        :param base_name: Base class, E.g: Expr or Stmt
        ...
        lines = [
            "# This file has been auto-generated by tools/generateAst.py",
        ...
        if imports:
            lines.extend(self.__defineImports(imports))

        lines.extend(self.__defineVisitor(base_name, types))
        ...
        for class_type in types:
            ...
            lines.extend(self.__defineType(base_name, class_name, fields))

        self.__writeFile(base_name, lines)

    def __defineImports(self, imports) -> list:
        lines = []
    ...
    def __defineVisitor(self, base_name: str, types: list) -> list:
    ...
    def __defineType(self, base_name: str, class_name: str, fields_list: str) -> list:
        # __init__ method
    ...
    def __writeFile(self, base_name: str, lines: list):
        """Write all the lines"""
...
if __name__ == "__main__":
    ...
    generateAst = GenerateAst(sys.argv[1])
